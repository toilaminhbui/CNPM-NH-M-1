    ...
    <div class="content">
        <div class="container" style="width: 1050px">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <p><span id="hoten">${info_quanly.hovaten}</span></p>
                </div>
                <div class="col-2">
                    <p><strong>Mã quản lý :</strong></p>
                </div>
                <div class="col-md-3">
                    <p><span id="manv">${info_quanly.nhanvien_id}</span></p>
                </div>
            </div>
            <div class="row">
                <div class="col-2">
                ...
                <div class="col-md-3">
                    <p><span id="sdt">${info_quanly.sdt}</span></p>
                </div>
                <div class="col-2">
                    <p><strong>Căn cước :</strong></p>
                </div>
                <div class="col-md-3">
                    <p><span id="sdt">${info_quanly.cccd}</span></p>
                </div>
            </div>
            <div class="row">
                <div class="col-2">
                ...
                <div class="col-md-3">
                    <p><span id="username">${info_quanly.username}</span></p>
                </div>
                <div class="col-2">
                    <p><strong>Email :</strong></p>
                </div>
                <div class="col-md-3">
                    <p><span id="email">${info_quanly.email}</span></p>
                </div>
            </div>
        </div>
        ...
        <div class="container mt-5" style="width: 1050px">
            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <form action="/Tinhtiendien/quan_ly/quan_ly_tai_khoan" method="POST">
