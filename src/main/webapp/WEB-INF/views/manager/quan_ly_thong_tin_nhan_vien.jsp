...
<!-- 	================================================= -->
	...
	<div style="margin-left: 0px;width:1300px" class="col-md-8 offset-md-2">
		<form class="custom-form" action = "/Tinhtiendien/quan_ly/quan_ly_thong_tin_nhan_vien/tim_kiem" method="GET">
		    <div class="row mb-3">
		        <div class="col">
		            <label for="field1" class="form-label">Mã nhân viên</label>
		            <input type="text" class="form-control" id="field1" name="search_nhanvien_id">
		        </div>
		        <div class="col">
		    ...
		    <div class="row mb-3">
		        <div class="col">
		        	...
		        	<label class="form-label">Nhập "." nếu bạn muốn tìm nhân viên không có email</label>
		        </div>
		        <div class="col">
		...
		<form action="/Tinhtiendien/quan_ly/quan_ly_thong_tin_nhan_vien" method="GET">
	...
	<div style="display: flex; justify-content: center; margin-bottom: -30px;">
			...
			<form action="/Tinhtiendien/quan_ly/quan_ly_thong_tin_nhan_vien" class="custom-form" id="submitPage" method="GET">
            ...
            <table class="table table-hover">
                ...
                <tbody>
	                <c:if test="${not empty listNV}">
	                  <c:forEach var="nv" varStatus="i" items="${listNV}">
				      <tr>
				      	<td>${nv.nhanvien_id}</td>
				        <td>${nv.hovaten}</td>
				        <td>${nv.gioitinh}</td>
				        <td><fmt:formatDate value="${nv.ngaythangnam_sinh}" pattern="dd-MM-yyyy"/></td>
				        <td>${nv.email}</td>
				        <td>${nv.sdt}</td>
				        <td>${nv.cccd}</td>
				        <td>${nv.diachi}</td>
				        <td>
				        	<button type="button" class="btn btn-primary btn-sm btn-edit" data-bs-toggle="modal" data-bs-target="#editEmployeeModal" onclick="setSelectForm('editForm')"><i class="bi bi-pencil-fill"></i> Sửa</button>
	                       	...
	                       	<input type="hidden" class="nhanvien_id" name="nv_id" value="${nv.nhanvien_id}">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- Add employee form -->
                        <form action = "/Tinhtiendien/quan_ly/quan_ly_thong_tin_nhan_vien/them" method="POST" id ="addCustomer" onsubmit="return validateDateAdd()" >
                            <div class="mb-3">
        ...
        <div class="modal fade" id="editEmployeeModal" tabindex="-1" aria-labelledby="editEmployeeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- Edit employee form -->
                        <form action = "/Tinhtiendien/quan_ly/quan_ly_thong_tin_nhan_vien/sua" method="POST" id ="editCustomer" onsubmit="return validateDateEdit()">
                            <div class="mb-3">
                            ...
                            <input type="hidden" class="nhanvien_id-edit" name="nhanvien_id" value="">
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
...
<!--         Delete Employee Modal -->
       	<div class="modal fade" id="deleteEmployeeModal" tabindex="-1" aria-labelledby="deleteEmployeeModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="deleteEmployeeModalLabel">Xóa nhân viên</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>
                        <form id="formToDelete" action="/Tinhtiendien/quan_ly/quan_ly_thong_tin_nhan_vien/xoa" method="POST">
                        	<input type="hidden" class="nhanvien_id-delete" name="nv_id" value="">
...
editButtons.forEach((button) => {
    button.addEventListener('click', (event) => {
        ...
        const nhanvien_id = row.querySelector('.nhanvien_id').value
        sessionStorage.setItem("nhanvien_id", id);
        ...
        document.querySelector('.nhanvien_id-edit').value = nhanvien_id
        
        console.log("nhanvien id: " + document.querySelector('.nhanvien_id-edit').value);
    });
});
...
deleteButtons.forEach((button) => {
    button.addEventListener('click', (event) => {
        ...
        document.querySelector('.nhanvien_id-delete').value = nhanvien_id
...
window.addEventListener('beforeunload', function() {
	...
	if (formType == "editForm") {
		sessionStorage.setItem("nhanvien_id", document.querySelector('.nhanvien_id-edit').value);
...
document.addEventListener("DOMContentLoaded", function() {
	...
	var nhanvien_id = sessionStorage.getItem("nhanvien_id");
	var hoten = sessionStorage.getItem("hoten");
	var gioitinh = sessionStorage.getItem("gioitinh");
	var ngay = sessionStorage.getItem("ngay");
	var thang = sessionStorage.getItem("thang");
	...
	$('.modal').on('hidden.bs.modal', function () {
		sessionStorage.removeItem("nhanvien_id");
		sessionStorage.removeItem("formType");
		sessionStorage.removeItem("hoten");
		sessionStorage.removeItem("gioitinh");
		sessionStorage.removeItem("email");
